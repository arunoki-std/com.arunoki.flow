...
namespace Arunoki.Flow.Builders
{
  public class UpdatableContainer : HubContainer<IUpdatable>
  {
    ...
    protected override void OnElementAdded (IUpdatable element)
    {
      ...
      switch (element)
      {
        case IFixedUpdatable a: Fixed.Add (a); break;
        case ILateUpdatable b: Late.Add (b); break;
        default:
    ...
    protected override void OnElementRemoved (IUpdatable element)
    {
      ...
      switch (element)
      {
        case IFixedUpdatable a: Fixed.Remove (a); break;
        case ILateUpdatable b: Late.Remove (b); break;
        default:
