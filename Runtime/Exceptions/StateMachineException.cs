...
namespace Arunoki.Flow
{
    public class StateMachineException : InvalidOperationException
    {
        ...
        internal static StateMachineException RootIsNotDefined(
            object stateMachine,
            string message = ""
        )
        {
        ...
        internal static StateMachineException StateIsNotDefined(
            string category,
            Type stateType,
            string message = ""
        )
        ...
        internal static StateMachineException RouterRegistrationOrder(
            object stateMachine,
            object router
        )
        {
